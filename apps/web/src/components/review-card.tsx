...
const ReviewCard: React.FC = () => {
  return (
    <div className="container flex flex-col w-full bg-[#23395d] text-white max-w-lg p-6 divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
